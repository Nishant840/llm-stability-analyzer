...
|------------------------------------|-----------:|----------------------------------------------------------------------|
| meta-llama/llama-3.2-1b-instruct   |        1B  | Ultra-compact baseline — tests minimum parametric stability          |
| meta-llama/llama-3.1-8b-instruct   |        8B  | Small-weight standard — common in edge deployments                   |
| google/gemma-2-27b-it              |       27B  | Mid-weight competitor — non-Meta architecture at scale               |
| meta-llama/llama-3.3-70b-instruct  |       70B  | Flagship model — upper bound of open-source capability               |
...
| Variant        | Description                                                                 |
|----------------|-----------------------------------------------------------------------------|
| Original       | Base question with no modification                                          |
...
| Std. Deviation               | -0.15  | Negative | Penalizes high variance — large swings in individual pair scores indicate unreliable behavior       |
...
|-----:|---------------------------|----------------------------------------------------------|
| 1    | Prompt Generation         | Create 6 variants per question                          |
...
_Minor Project completed under the supervision of_  
**Dr. Neeta Anna Eapen**
